...
void check_breverse(testresult_t *result, void (*start)(), void (*stop)()) {
  ...
  asm volatile ("li x11, 2113463793;"
  ".word 0xc5b5d5b3;"
  "nop" : : : "x11", "x11");
  ...
  asm volatile ("li x10, 3867352602;"
  ".word 0xc5b55533;"
  "nop" : : : "x10", "x10");
  ...
  asm volatile ("li x22, 2288380116;"
  ".word 0xc24b5b33;"
  "nop" : : : "x22", "x22");
  ...
  asm volatile ("li x25, 2669777747;"
  ".word 0xc5bcdcb3;"
  "nop" : : : "x25", "x25");
  ...
  asm volatile ("li x20, 3496053773;"
  ".word 0xc22a5a33;"
  "nop" : : : "x20", "x20");
