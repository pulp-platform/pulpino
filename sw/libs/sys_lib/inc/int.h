...
void ISR_TA_CMP (void); // 28: timer A compare
void ISR_TA_OVF (void); // 29: timer A overflow
void ISR_TB_CMP (void); // 30: timer B compare
void ISR_TB_OVF (void); // 31: timer B overflow
