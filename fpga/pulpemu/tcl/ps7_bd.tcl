...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {50} CONFIG.PCW_S_AXI_HP0_DATA_WIDTH {64} CONFIG.PCW_USE_S_AXI_HP0 {0} CONFIG.preset {ZC706}  ] $processing_system7_0
