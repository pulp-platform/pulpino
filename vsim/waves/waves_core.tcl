...
add wave -group "IF Stage" -group "Hwlp Ctrl"              /tb/top_i/core_region_i/RISCV_CORE/if_stage_i/hwloop_controller_i/*
add wave -group "IF Stage" -group "Prefetch" -group "FIFO" /tb/top_i/core_region_i/RISCV_CORE/if_stage_i/prefetch_32/prefetch_buffer_i/fifo_i/*
...
add wave -group "RF"                                       /tb/top_i/core_region_i/RISCV_CORE/id_stage_i/registers_i/mem
